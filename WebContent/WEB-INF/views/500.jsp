	...
	<body><!-- Available classes for body: boxed , pattern1...pattern10 . Background Image - example add: data-background="/static/assets/images/boxed_background/1.jpg"  -->
		...
		<%@include file="portal/common/head.jsp" %>
			<div class="notFound error-title">
				<img class="notFound-img" alt="" src="<c:url value="/static/assets/images/demo/error/title-500.png" />">
			</div>
			<div class="notFound">
				<img class="notFound-img" alt="" src="<c:url value="/static/assets/images/demo/error/500.png" />">
				<h3 class="error-tip"><i class="fa fa-info-circle"></i> 请 刷 新 页 面 重 试</h3>
			</div>
			<div style="position: absolute;bottom: 0px;width:100%;">
			<%-- 去掉网页尾部信息
			<%@include file="portal/common/foot.jsp" %>
			--%>
			</div>
		</div>
		<!-- /WRAPPER -->
